...
const NavbarComponents = () => {
  ...
  const [changeColor, setChangeColor] = useState(
    "bg-gradient-to-b from-hijau-200 to-hijau-sage"
  );
  ...
  return (
    <div>
      <div
        className={`${
          changeBorder ? "border-b border-abu" : ""
        } ${changeColor} navbar md:px-16 md:py-4 py-1 fixed top-0 w-full z-50 transition-all duration-300`}
      >
        <div className="navbar-start">
                ...
                <li key={link.id}>
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `${
                        isActive
                          ? "border-b-2 border-hijau-500 text-hijau-500"
                          : ""
          ...
          <NavLink
            to="/"
            className="btn btn-ghost md:text-3xl text-xl text-hijau-500 italic"
          >
            ...
            <div className="dropdown dropdown-end">
              ...
              >
                <div className="indicator">
                  ...
                  <span className="badge badge-sm indicator-item bg-hijau-500 text-white">
                    2
                  </span>
                </div>
              </div>
              ...
              >
                <div className="card-body">
                  ...
                  <div className="card-actions">
                    <NavLink
                      to="/keranjang"
                      className="btn bg-hijau-500 hover:bg-hijau-600 text-white btn-block"
                    >
                      Lihat Keranjang
                    </NavLink>
                  </div>
