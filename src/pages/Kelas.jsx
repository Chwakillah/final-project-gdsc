    ...
    <div className="w-full min-h-screen md:px-20">
      <div className="flex flex-col py-24 p-8 gap-4">
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-4 lg:gap-8 justify-center">
          {kelasTPS.map((tps) => (
            <div key={tps.id}>
              <NavLink className="flex flex-col gap-4 border-2 border-background-subtle p-3 rounded-lg text-center hover:bg-hijau-200 hover:border-hijau-500 transform transition-all duration-300 cursor-pointer ease-in-out" to={tps.path}>
                <img
                  src={tps.img}
