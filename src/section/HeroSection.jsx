...
function HeroSection() {
  return (
    <div>
      <header className="w-full min-h-screen px-8 md:px-20 flex flex-col lg:flex-row justify-center gap-12 relative items-center bg-gradient-to-b from-hijau-sage to-white py-24 z-0">
          ...
          >
            <div className="flex flex-col gap-2 justify-center w-full lg:gap-4">
              ...
              <h1 className="text-hijau-800 text-2xl md:text-3xl lg:text-5xl font-semibold">
                Percayakan <span className="text-hijau-600">Persiapanmu</span>{" "}
                <br /> Masuk <span className="text-hijau-600">PTN </span>
                bersama <br /> <span className="text-hijau-500">Les</span>{" "}
                <span className="text-oren-500">Tasya</span>
              </h1>
            ...
            <div>
              <label className="input  flex items-center gap-2 shadow-md z-0">
                <input
                  type="text"
                  className="grow text-xs md:text-sm lg:text-base"
