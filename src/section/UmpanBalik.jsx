...
const UmpanBalik = () => {
  return (
    <div className="w-full min-h-screen md:px-32 lg:px-56 overflow-x-hidden px-8 py-24 flex flex-col justify-center items-center relative gap-8">
      ...
      <div className="flex md:flex-row flex-col md:gap-12">
        <div className="flex flex-col gap-8 md:gap-20">
          {umpanKiri.map((umpan) => (
            <div className="chat chat-start gap-2" key={umpan.id}>
        ...
        <div className="md:pt-20 pt-8 flex flex-col gap-8 md:gap-20">
          {umpanKanan.map((umpan) => (
            <div className="chat chat-end gap-2" key={umpan.id}>
              <div className="chat-image avatar">
                <div className="w-10 rounded-full">
                  <img alt="chat bubble component" src={umpan.img} />
                </div>
